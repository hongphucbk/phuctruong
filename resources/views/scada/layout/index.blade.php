...
<head>
    ...
    <base href="{{asset('')}}">
    <!-- Bootstrap Core CSS -->
    <link href="scada/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="scada/css/style.css" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="scada/css/colors/blue.css" id="theme" rel="stylesheet">
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
        @include('scada.layout.left_slidebar')
        <!-- ============================================================== -->
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="scada/assets/plugins/jquery/jquery.min.js"></script>
