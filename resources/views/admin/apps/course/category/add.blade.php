    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="admin/app/course/category/add">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="admin/app/course/category/add" method="post">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <h3 class="card-title">Add new course category</h3>
                            <hr>
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label class="control-label">Course Note</label>
