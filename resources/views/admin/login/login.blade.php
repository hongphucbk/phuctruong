...
<head>
    ...
    <base href="{{asset('')}}">
    <!-- page css -->
    <link href="source/dist/css/pages/login-register-lock.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(source/images/background/login-register.jpg);">
        <div class="login-box card">
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="loginform" action="admin/login" method="post">
                	{{ csrf_field() }}
                    <a href="javascript:void(0)" class="text-center db"><img src="source/images/logo-icon.png" alt="Home" /><br/><!-- <img src="source/images/logo-text.png" alt="Home" /> --></a>
