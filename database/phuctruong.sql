...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 12, 2018 lúc 02:05 AM
...
(1, 'Admin', 'Full access', '2018-11-11 17:00:54', '2018-11-11 17:00:54');
...
ALTER TABLE `roles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `roles_users_group_id_foreign` (`users_group_id`);
...
--
ALTER TABLE `roles`
  ADD CONSTRAINT `roles_users_group_id_foreign` FOREIGN KEY (`users_group_id`) REFERENCES `users_group` (`id`);
